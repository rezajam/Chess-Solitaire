...
extern EIF_TYPED_VALUE F1418_13349(EIF_REFERENCE);
extern void F1418_16568(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1418_13349 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1418_16568 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1417, Current, 0, 16567);
	RTSA(dtype);
	RTME(dtype, 0);
