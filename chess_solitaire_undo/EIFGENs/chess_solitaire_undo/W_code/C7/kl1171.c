...
extern EIF_TYPED_VALUE F1171_10253(EIF_REFERENCE);
...
RTOID (F1171_10253)
EIF_TYPED_VALUE F1171_10253 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1170, Current, 0, 0, 16812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1170, Current, 16812);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80004B9, 0,0); /* Result */
