...
extern void F1163_10230(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1163_10231(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1163(void);
extern EIF_REFERENCE _A1163_184_2();
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1162, Current, 0, 1, 16790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1162, Current, 16790);
	{
		...
		RTCC(arg1, 1162, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
	...
	*((EIF_INTEGER_32 *)tr3+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1163_184_2, (EIF_POINTER)(0),7801, tr2, 0, 1, -1, tr1, 1);
	}
	ur1 = RTCCL(tr4);
...
void F1163_10230 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1162, Current, 0, 2, 16788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1162, Current, 16788);
	RTCC(arg1, 1162, l_feature_name, 1, eif_new_type(238, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,263,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1163_10231 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1162, Current, 0, 1, 16789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1162, Current, 16789);
	RTIV(Current, RTAL);
