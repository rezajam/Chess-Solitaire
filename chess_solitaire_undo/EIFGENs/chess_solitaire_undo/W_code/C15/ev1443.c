...
extern void F1443_13711(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1443_13712(EIF_REFERENCE);
static EIF_TYPED_VALUE F1443_13713_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1443_13713(EIF_REFERENCE);
...
void F1443_13711 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1442, Current, 0, 1, 20102);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1442, Current, 20102);
	RTCC(arg1, 1442, l_feature_name, 1, RTWCT(9372, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1443_13712 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9367, 1441))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1443_13713_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20104);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1443_13713 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1443_13713_body (Current)).it_r;
