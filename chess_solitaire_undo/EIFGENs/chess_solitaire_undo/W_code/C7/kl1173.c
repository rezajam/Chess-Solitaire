...
extern EIF_TYPED_VALUE F1173_10275(EIF_REFERENCE);
...
RTOID (F1173_10275)
EIF_TYPED_VALUE F1173_10275 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1172, Current, 0, 0, 16853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
