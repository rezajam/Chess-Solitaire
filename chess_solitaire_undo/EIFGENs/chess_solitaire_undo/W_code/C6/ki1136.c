...
extern EIF_TYPED_VALUE F1136_10032(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1136_10032 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1135, Current, 0, 1, 16274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16274);
	RTCC(arg1, 1135, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
