...
extern EIF_TYPED_VALUE F1400_13244(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1400_13245(EIF_REFERENCE);
extern void F1400_13246(EIF_REFERENCE);
extern void F1400_13247(EIF_REFERENCE);
extern void F1400_13248(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1400_13249_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1400_13249(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1400_13244 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1399, Current, 2, 0, 19743);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19743);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10119, 0x04000000, 1); /* is_docking_enabled */
	*(EIF_BOOLEAN *)(Current + RTWA(10119, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	...
	if (EIF_TEST(loc1)) {
		...
		RTNHOOK(4,1);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9684, "dockable_targets", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,2);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(10119, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1400_13247 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1399, Current, 2, 0, 19744);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19744);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("application_exists", EX_PRE);
...
void F1400_13248 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1399, Current, 0, 1, 19745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19745);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {257,0xFF01,0xFFF9,1,186,0xFF01,1274,200,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
			
			typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(Dftype(Current), typarr0)));
			RTCC(arg1, 1399, l_feature_name, 1, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10118, 0xF8000101, 0); /* veto_dock_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1400_13249_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1399, Current, 0, 0, 19746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1399, Current, 19746);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1400_13249 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1400_13249_body (Current)).it_r;
