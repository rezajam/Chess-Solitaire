...
extern EIF_TYPED_VALUE F1364_12375(EIF_REFERENCE);
static EIF_TYPED_VALUE F1364_12394_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1364_12394(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1364_12375 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1363, Current, 2, 0, 19047);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1363, Current, 19047);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
	RTHOOK(19);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9453, dtype))(Current)).it_b);
	RTNHOOK(19,1);
	tr1 = (tb1 ? makestr ("True", 4) : makestr ("False", 5));
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
...
static EIF_TYPED_VALUE F1364_12394_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1363, Current, 0, 0, 19048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1363, Current, 19048);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1364_12394 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1364_12394_body (Current)).it_r;
