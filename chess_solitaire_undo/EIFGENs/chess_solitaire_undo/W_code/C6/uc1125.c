...
extern EIF_TYPED_VALUE F1125_9964(EIF_REFERENCE);
...
RTOID (F1125_9964)
EIF_TYPED_VALUE F1125_9964 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1124, Current, 0, 0, 16210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1124, Current, 16210);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
