...
extern void F1127_9966(EIF_REFERENCE);
...
/* {OBJ_START_GAME}.make */
void F1127_9966 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1126, Current, 1, 0, 16212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_REFERENCE *)(Current + RTWA(7617, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(2,1);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6317, "start_bool", tr1))(tr1, ub1x);
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7617, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
