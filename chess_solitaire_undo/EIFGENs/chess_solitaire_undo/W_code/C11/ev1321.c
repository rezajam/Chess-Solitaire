...
extern EIF_TYPED_VALUE F1321_11949(EIF_REFERENCE);
extern void F1321_11950(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1321_11949 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1321_11950 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1320, Current, 0, 0, 18641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1320, Current, 18641);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8443, 0xF80005BB, 0); /* implementation */
