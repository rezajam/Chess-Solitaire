...
extern void F1153_10195(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1153_10196(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1153_10197(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1153_10198(EIF_REFERENCE);
extern void F1153_10199(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1153_10195 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1152, Current, 1, 1, 16757);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16757);
	if (arg1) {
		{
			...
			RTCC(arg1, 1152, l_feature_name, 1, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
...
void F1153_10196 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1152, Current, 0, 1, 16758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16758);
	if (arg1) {
		{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7788, 0xF8000101, 0); /* veto_pebble_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1153_10197 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1152, Current, 2, 1, 16759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16759);
	RTIV(Current, RTAL);
...
void F1153_10199 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1152, Current, 0, 2, 16755);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16755);
	{
	...
	RTCC(arg2, 1152, l_feature_name, 2, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1152, Current, 2, 1, 16756);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16756);
	RTIV(Current, RTAL);
	RTHOOK(1);
