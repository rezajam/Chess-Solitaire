...
extern EIF_TYPED_VALUE F994_8598(EIF_REFERENCE);
...
RTOID (F994_8598)
EIF_TYPED_VALUE F994_8598 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 993, Current, 0, 0, 14939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(993, Current, 14939);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
