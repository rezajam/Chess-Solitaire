...
#define ui4_2 ui4_2x.it_i4
	...
	ui4_1 = ti4_1;
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5138, 967))(Current)).it_i4);
	ui4_2 = ti4_2;
	...
	RTHOOK(3);
	up1 = loc1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5480, 967))(Current, up1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTHOOK(1);
	RTDBGAL(1, 0x40000000, 1, 0); /* loc1 */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6136, 968))(Current)).it_p);
	loc1 = (EIF_POINTER) tp1;
	RTHOOK(2);
	RTDBGAL(0, 0xF80004EF, 0,0); /* Result */
	up1 = loc1;
...
body:;
	...
	switch (arg2) {
		...
		case 4L:
			...
			RTDBGAL(2, 0x40000000, 1, 0); /* loc2 */
			up1 = loc1;
			tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5605, 967))(Current, up1x)).it_p);
			loc2 = (EIF_POINTER) tp1;
			break;
		case 3L:
			RTHOOK(7);
