...
extern EIF_TYPED_VALUE F1206_10506(EIF_REFERENCE);
...
RTOID (F1206_10506)
EIF_TYPED_VALUE F1206_10506 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1205, Current, 0, 0, 17125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1205, Current, 17125);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
