note
	description: "Summary description for {Q}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
	...
	moves (k_x: INTEGER_32; k_y: INTEGER_32): ARRAY [TUPLE [INTEGER_32, INTEGER_32]]
		...
		do
			...
			AT.force ([k_x - 1, k_y + 1], AT.count + 1)
				...
				-- +- (2)
			AT.force ([k_x + 2, k_y], AT.count + 1)
			AT.force ([k_x - 2, k_y], AT.count + 1)
			AT.force ([k_x, k_y + 2], AT.count + 1)
			AT.force ([k_x, k_y - 2], AT.count + 1)
			AT.force ([k_x + 2, k_y + 2], AT.count + 1)
			AT.force ([k_x - 2, k_y - 2], AT.count + 1)
			AT.force ([k_x + 2, k_y - 2], AT.count + 1)
			AT.force ([k_x - 2, k_y + 2], AT.count + 1)
				-- +- (3)
			AT.force ([k_x + 3, k_y], AT.count + 1)
			AT.force ([k_x - 3, k_y], AT.count + 1)
			AT.force ([k_x, k_y + 3], AT.count + 1)
			AT.force ([k_x, k_y - 3], AT.count + 1)
			AT.force ([k_x + 3, k_y + 3], AT.count + 1)
			AT.force ([k_x - 3, k_y - 3], AT.count + 1)
			AT.force ([k_x + 3, k_y - 3], AT.count + 1)
			AT.force ([k_x - 3, k_y + 3], AT.count + 1)
