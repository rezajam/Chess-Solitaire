...
extern void F1346_12198(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1346_12199(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1346_12200(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1346_12201(EIF_REFERENCE);
extern void F1346_12202(EIF_REFERENCE);
extern void F1346_12203(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1346_12204(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1346_12205(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1346_12198 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1345, Current, 0, 1, 18892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18892);
	{
...
EIF_TYPED_VALUE F1346_12199 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1345, Current, 0, 0, 18893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18893);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1346_12200 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1345, Current, 1, 0, 18894);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18894);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1345, Current, 1, 0, 18895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18895);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1346_12202 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1345, Current, 0, 0, 18896);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18896);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1346_12203 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1345, Current, 1, 1, 18897);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18897);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,267,0xFF01,229,221,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1346_12204 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1345, Current, 0, 0, 18898);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18898);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8448, 1314))(Current)).it_b);
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8448, 1585))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1346_12205 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1345, Current, 0, 1, 18899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1345, Current, 18899);
	RTCC(arg1, 1345, l_feature_name, 1, eif_new_type(1329, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
