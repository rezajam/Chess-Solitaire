...
extern EIF_TYPED_VALUE F995_8599(EIF_REFERENCE);
extern EIF_TYPED_VALUE F995_8600(EIF_REFERENCE);
...
RTOID (F995_8599)
EIF_TYPED_VALUE F995_8599 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14940);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F995_8600)
EIF_TYPED_VALUE F995_8600 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 14941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(994, Current, 14941);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8599,F995_8599)
	RTOTS (8600,F995_8600)
}
