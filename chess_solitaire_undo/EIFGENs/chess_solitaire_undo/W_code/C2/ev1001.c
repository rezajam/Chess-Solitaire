...
extern EIF_TYPED_VALUE F1001_8679(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1001_8679 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1000, Current, 1, 1, 15019);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 15019);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6466, dtype))(Current)).it_n4);
