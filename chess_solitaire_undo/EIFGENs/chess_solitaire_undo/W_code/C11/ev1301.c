...
extern EIF_TYPED_VALUE F1301_11671(EIF_REFERENCE);
extern void F1301_11672(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1301_11671 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1301_11672 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1300, Current, 0, 0, 18362);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1300, Current, 18362);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8443, 0xF80005A0, 0); /* implementation */
