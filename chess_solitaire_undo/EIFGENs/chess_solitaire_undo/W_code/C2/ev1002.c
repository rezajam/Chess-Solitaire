...
extern EIF_TYPED_VALUE F1002_8680(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1002_8680 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1001, Current, 1, 0, 15020);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1001, Current, 15020);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11039, "horizontal_resolution", loc1))(loc1)).it_i4);
	RTNHOOK(2,1);
