...
extern EIF_TYPED_VALUE F1174_10276(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1174_10276 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	if (arg1) {
		RTCC(arg1, 1173, l_feature_name, 1, eif_new_type(232, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 1173, l_feature_name, 2, eif_new_type(232, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (RTCEQ(arg1, arg2)) {
