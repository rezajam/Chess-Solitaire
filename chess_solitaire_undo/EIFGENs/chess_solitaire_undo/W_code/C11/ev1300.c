...
extern EIF_TYPED_VALUE F1300_11669(EIF_REFERENCE);
extern void F1300_11670(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1300_11669 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1300_11670 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1299, Current, 0, 0, 18360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1299, Current, 18360);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8443, 0xF800059F, 0); /* implementation */
