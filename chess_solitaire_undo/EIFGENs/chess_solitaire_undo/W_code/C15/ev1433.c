...
extern void F1433_13614(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1433_13615_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1433_13615(EIF_REFERENCE);
...
void F1433_13614 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1432, Current, 1, 1, 20026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 20026);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1433_13615_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1432, Current, 0, 0, 20027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1432, Current, 20027);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1433_13615 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1433_13615_body (Current)).it_r;
