...
extern EIF_TYPED_VALUE F1556_15678(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1556_15679(EIF_REFERENCE);
extern void F1556_15680(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1556_15678 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1556_15679 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1556_15680 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1555, Current, 0, 0, 21746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1555, Current, 21746);
	RTIV(Current, RTAL);
