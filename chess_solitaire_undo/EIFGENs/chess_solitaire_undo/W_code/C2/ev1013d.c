...
static const EIF_TYPE_INDEX egt_13_1013 [] = {0xFF01,1169,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_13_1013), 15053, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0923 /*1169*/), 15054, 0},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 800, 1012);
}
