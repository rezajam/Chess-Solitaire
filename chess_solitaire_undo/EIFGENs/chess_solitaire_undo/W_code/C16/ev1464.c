...
extern EIF_TYPED_VALUE F1464_14052(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1464_14053(EIF_REFERENCE);
extern void F1464_14061(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1464_14062_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1464_14062(EIF_REFERENCE);
extern void F1464_16575(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1464_14052 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1464_14053 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1463, Current, 2, 0, 20364);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20364);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1464_14061 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1463, Current, 2, 1, 20365);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20365);
	RTIV(Current, RTAL);
...
static EIF_TYPED_VALUE F1464_14062_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1463, Current, 0, 0, 20366);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20366);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1464_14062 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1464_14062_body (Current)).it_r;
...
void F1464_16575 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1463, Current, 0, 16574);
	RTSA(dtype);
	RTME(dtype, 0);
