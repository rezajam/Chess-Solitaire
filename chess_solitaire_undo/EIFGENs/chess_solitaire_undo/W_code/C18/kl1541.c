...
extern EIF_TYPED_VALUE F1541_15380(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1541_15380 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1540, Current, 0, 0, 21507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1540, Current, 21507);
	RTIV(Current, RTAL);
	RTHOOK(1);
