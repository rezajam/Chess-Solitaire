...
static EIF_TYPED_VALUE F1405_13274_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1405_13274(EIF_REFERENCE);
...
void F1405_13272 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1404, Current, 0, 0, 19760);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1405_13274_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1404, Current, 0, 0, 19761);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1405_13274 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1405_13274_body (Current)).it_r;
