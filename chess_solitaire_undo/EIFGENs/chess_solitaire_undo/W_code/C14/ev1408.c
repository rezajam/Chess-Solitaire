...
static EIF_TYPED_VALUE F1408_13284_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1408_13284(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1408_13284_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1407, Current, 0, 0, 19767);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1408_13284 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1408_13284_body (Current)).it_r;
