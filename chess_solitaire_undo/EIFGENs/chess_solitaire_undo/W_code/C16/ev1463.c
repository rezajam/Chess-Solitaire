...
extern void F1463_14044(EIF_REFERENCE);
static EIF_TYPED_VALUE F1463_14048_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1463_14048(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1463_14044 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20361);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1463_14048_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1462, Current, 0, 0, 20362);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1462, Current, 20362);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1463_14048 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9372, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1463_14048_body (Current)).it_r;
