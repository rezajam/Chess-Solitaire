...
extern EIF_TYPED_VALUE F999_8622(EIF_REFERENCE);
...
RTOID (F999_8622)
EIF_TYPED_VALUE F999_8622 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 14963);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 14963);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
