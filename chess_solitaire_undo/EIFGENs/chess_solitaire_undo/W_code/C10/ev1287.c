...
extern EIF_TYPED_VALUE F1287_11385(EIF_REFERENCE);
extern void F1287_11386(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1287_11387(EIF_REFERENCE);
...
/* {EV_FONTABLE}.font */
EIF_TYPED_VALUE F1287_11385 (EIF_REFERENCE Current)
{
	GTCX
...
void F1287_11386 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1286, Current, 0, 1, 18078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1286, Current, 18078);
	RTCC(arg1, 1286, l_feature_name, 1, eif_new_type(1264, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1287_11387 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
